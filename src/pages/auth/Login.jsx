...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-200 bg-[url('/auth/background.jpg')] bg-cover bg-center">
      <form
        className="backdrop-blur-md bg-white/10  p-4 w-5/6 md:w-2/3 text-gray-100 rounded-lg "
      ...
      >
        ...
        <GoogleLogin />
         <div className="divider divider-accent">Or Login With Credentials</div>
        <div>
        ...
        <button
          className="w-full bg-gray-600 text-white mt-2 py-1 rounded-sm cursor-pointer hover:shadow shadow-accent hover:bg-gray-700"
          type="submit"
        >
          Login
        </button>
